...
export function formatApiError(detail) {
  if (detail == null || detail === "") return "Something went wrong. Please try again.";
  ...
  // Avoid dumping raw objects like "[object Object]" into toasts.
  if (typeof detail === "object") return "Something went wrong. Please try again.";
